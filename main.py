...
def greet_loud(name: str = "World") -> str:
    """Return a greeting in uppercase (e.g. for emphasis)."""
    return greet(name).upper()


def bye(who: str = "you") -> str:
    """Return a short goodbye."""
    return f"Bye, {who}!"


def say_hi(name: str = "there") -> str:
    """Return a casual hi message."""
    return f"Hi, {name}!"


def hello_again(name: str = "friend") -> str:
    """Return a hello-again style greeting."""
